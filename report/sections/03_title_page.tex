...
\aautitlepage{%
  ...
  In this project a mechanical turntable with a mounted receiver antenna and a VNA connected to the receiver antenna and a transmitter antenna is used to measure in a controlled environment to be able to determine the gain of the received signal in the horizontal plane. The antennas are two identical horn antennas with a gain of \SI{11.41}{\decibel} at $f=\SI{4.75}{\giga\hertz}$ and \SI{12.99}{\decibel} at $f=\SI{5.65}{\giga\hertz}$ that were used to test the full system with different setups with and without a static intruder. The results show that the maximum gain of the received signal at both frequencies is in the direction of the transmitter with reflections detected in directions of vertical surfaces in the measurement space, and that the maximum gain in the direction of the transmitter measured is higher without intruder. It is concluded that an intruder can be detected with the system when comparing with measurements without intruder and that the intruder affects the direction of the maximum gain measured in the environment. 
}
