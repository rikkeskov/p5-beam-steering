...
This project was developed by Rikke Udengaard in the Spring semester of 2024 at Department of Electronic System at Aalborg University. The theme of this 5th semester project is \textit{Digital and Analog Systems in Cooperation with the World}. 
\\[12pt]
\noindent The final product includes source code that is available on \textit{Github}. The link to the repository can be found in appendix \ref{a:code} with some of the source code is explained in chapter \ref{ch:implementation}. The repository also contains the test result logs which are also available in condensed form in the appendix \ref{a:results}.
\\[12pt]
