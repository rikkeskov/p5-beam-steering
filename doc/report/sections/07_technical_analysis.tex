...
\todo[color=blue]{make short introduction}
...
\begin{equation}
    ...
    \end{split}
\end{equation}
\todo[color=blue]{explain each letter}
...
\todo[color=blue]{insert figure of planar coordinates and explain}
...
\todo[color=blue]{add p4 rf antenna beam forming eq of power through area}
\todo[color=blue]{expand maxwell eqs with frequency dependencies p4 rf antenna beam forming}

\subsubsection{Multipath propagation}
\todo[color=red]{describe multipath propagation and what issues it brings and how to mitigate. Also any advantages}

\subsection{Polarization}
\todo[color=red]{describe polarization and what issues it brings and how to mitigate. Also any advantages}
...
\todo[color=red]{describe typical antenna designs. see p11 rf antenna beam forming}


\section{Beam Steering Methods}

\subsection{Manual and Mechanical Steering}
\todo[color=green]{explain motor control and types of motors with type of control loops}
