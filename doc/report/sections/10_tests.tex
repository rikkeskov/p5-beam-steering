...
\todo[color=blue]{elaborate and do test}
...
\todo[color=blue]{elaborate introduction}
...
\end{itemize}
\todo[color=blue]{find exact values and names}
...
\todo[color=blue]{add VNA environmental conditions}
...
\end{enumerate}
\todo[color=blue]{elaborate on the how}
...
\end{figure}
\todo[color=blue]{improve this figure because it is ugly. Needs more names}

\section{Test Results}
\todo[color=blue]{add table for test results and describe}